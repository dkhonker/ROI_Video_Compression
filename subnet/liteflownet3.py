...
'''
try:
    from .lf3_correlation import correlation # the custom cost volume layer
except: 
    from lf3_correlation import correlation # the custom cost volume layer
'''
##########################################################
...
arguments_strFirst = 'autodl-tmp/subnet/images/first.png'
arguments_strSecond = 'autodl-tmp/subnet/images/second.png'
arguments_strOut = 'autodl-tmp/subnet/out.flo'
...
class LiteFlowNet3(torch.nn.Module):
    def __init__(self):
        ...
        self.load_state_dict(torch.load('autodl-tmp/subnet/network-{}.pytorch'.format(arguments_strModel)))
    # end
